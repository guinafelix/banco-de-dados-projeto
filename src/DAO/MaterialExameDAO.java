...
public class MaterialExameDAO extends ConexaoDB {
	...
	private static final String BUSCAR_POR_MATERIAL_MATERIAL_EXAME_SQL = "SELECT FROM material_exame WHERE material = ?;";
	...
	public MaterialExame findByDecricao(String material) {
